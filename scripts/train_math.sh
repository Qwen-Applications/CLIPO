...
TRAIN_FILE="${TRAIN_FILE_DIR}/math75.parquet"
TEST_FILE="['${TEST_FILE_DIR}/math.parquet','${TEST_FILE_DIR}/aime.parquet','${TEST_FILE_DIR}/aime2025.parquet','${TEST_FILE_DIR}/amc.parquet','${TEST_FILE_DIR}/math_perturb_simple.parquet','${TEST_FILE_DIR}/math_perturb_hard.parquet']"

project_name="clipo_math"
