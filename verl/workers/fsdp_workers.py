...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        # mark hidden_size for creating contrastive_head
        self.actor_hidden_size = actor_module.config.hidden_size
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if self.config.model.get("enable_con_lm_head", False):
            # Set enable_return_hidden_states in rollout config before converting to dataclass
            with open_dict(self.config.rollout):
                self.config.rollout.enable_return_hidden_states = True
    ...
    def get_actor_hidden_size(self):
        """Get the hidden size of the actor model."""
        return getattr(self, 'actor_hidden_size', None)
